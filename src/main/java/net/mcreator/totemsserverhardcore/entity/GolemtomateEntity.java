...
public class GolemtomateEntity
extends Monster {
    public GolemtomateEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<GolemtomateEntity>)((EntityType)KuromymodModEntities.GOLEMTOMATE.get()), world);
    }

    public GolemtomateEntity(EntityType<GolemtomateEntity> type, Level world) {
        super(type, world);
        this.xRotO = 0;
