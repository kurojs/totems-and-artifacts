...
public class GolemHongoEntity
extends Monster {
    public GolemHongoEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<GolemHongoEntity>)((EntityType)KuromymodModEntities.GOLEM_HONGO.get()), world);
    }

    public GolemHongoEntity(EntityType<GolemHongoEntity> type, Level world) {
        super(type, world);
        this.xRotO = 0;
