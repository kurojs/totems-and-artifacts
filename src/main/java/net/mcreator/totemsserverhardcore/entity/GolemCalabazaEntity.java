...
public class GolemCalabazaEntity
extends Monster {
    public GolemCalabazaEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<GolemCalabazaEntity>)((EntityType)KuromymodModEntities.GOLEM_CALABAZA.get()), world);
    }

    public GolemCalabazaEntity(EntityType<GolemCalabazaEntity> type, Level world) {
        super(type, world);
        this.xRotO = 0;
