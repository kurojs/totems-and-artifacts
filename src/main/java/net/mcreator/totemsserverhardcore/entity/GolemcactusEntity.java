...
public class GolemcactusEntity
extends Monster {
    public GolemcactusEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<GolemcactusEntity>)((EntityType)KuromymodModEntities.GOLEMCACTUS.get()), world);
    }

    public GolemcactusEntity(EntityType<GolemcactusEntity> type, Level world) {
        super(type, world);
        this.xRotO = 0;
    ...
    protected void m_8099_() {
        super.registerGoals();
        this.goalSelector.addGoal(1, new MeleeAttackGoal((PathfinderMob)this, 1.2, false){

            protected double getAttackReachSqr(LivingEntity entity) {
                return 4.0 + entity.getBbWidth() * entity.getBbWidth();
            }
        });
        this.goalSelector.addGoal(2, new RandomStrollGoal((PathfinderMob)this, 1.0));
