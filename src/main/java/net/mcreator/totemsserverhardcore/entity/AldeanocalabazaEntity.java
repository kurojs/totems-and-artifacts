...
public class AldeanocalabazaEntity
extends Monster {
    public AldeanocalabazaEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<AldeanocalabazaEntity>)((EntityType)KuromymodModEntities.ALDEANOCALABAZA.get()), world);
    }

    public AldeanocalabazaEntity(EntityType<AldeanocalabazaEntity> type, Level world) {
        super(type, world);
        this.xRotO = 0;
