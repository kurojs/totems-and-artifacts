...
public class AldeanopinaEntity
extends Monster {
    public AldeanopinaEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<AldeanopinaEntity>)((EntityType)KuromymodModEntities.ALDEANOPINA.get()), world);
    }

    public AldeanopinaEntity(EntityType<AldeanopinaEntity> type, Level world) {
        super(type, world);
        this.xRotO = 0;
