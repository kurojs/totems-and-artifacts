...
public class AldeanohongomaloEntity
extends Monster {
    public AldeanohongomaloEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<AldeanohongomaloEntity>)((EntityType)KuromymodModEntities.ALDEANOHONGOMALO.get()), world);
    }

    public AldeanohongomaloEntity(EntityType<AldeanohongomaloEntity> type, Level world) {
        super(type, world);
        this.xRotO = 0;
    ...
    public void m_7355_(BlockPos pos, BlockState blockIn) {
        this.playSound((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.zombie_villager.step")), 0.15f, 1.0f);
    }
