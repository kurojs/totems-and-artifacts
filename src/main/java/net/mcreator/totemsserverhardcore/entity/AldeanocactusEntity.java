...
public class AldeanocactusEntity
extends Monster {
    public AldeanocactusEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<AldeanocactusEntity>)((EntityType)KuromymodModEntities.ALDEANOCACTUS.get()), world);
    }

    public AldeanocactusEntity(EntityType<AldeanocactusEntity> type, Level world) {
        super(type, world);
        this.xRotO = 0;
