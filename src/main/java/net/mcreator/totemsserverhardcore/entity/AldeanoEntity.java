...
public class AldeanoEntity
extends Monster {
    public AldeanoEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<AldeanoEntity>)((EntityType)KuromymodModEntities.ALDEANO.get()), world);
    }

    public AldeanoEntity(EntityType<AldeanoEntity> type, Level world) {
        super(type, world);
        this.xRotO = 0;
