...
public class Modelcactus<T extends Entity>
extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("kuromymod", "modelcactus"), "main");
    ...
    public Modelcactus(ModelPart root) {
