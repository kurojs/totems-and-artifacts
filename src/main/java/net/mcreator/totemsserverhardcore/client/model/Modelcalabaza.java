...
public class Modelcalabaza<T extends Entity>
extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("kuromymod", "modelcalabaza"), "main");
    ...
    public Modelcalabaza(ModelPart root) {
